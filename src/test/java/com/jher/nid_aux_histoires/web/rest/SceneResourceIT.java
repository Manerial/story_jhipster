...
public class SceneResourceIT {
    ...
    private static final String DEFAULT_TIMESTAMP_START = "AAAAAAAAAA";
    private static final String UPDATED_TIMESTAMP_START = "BBBBBBBBBB";
    ...
    public void getAllScenes() throws Exception {
        ...
        restSceneMockMvc.perform(get("/api/scenes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].timestampStart").value(hasItem(DEFAULT_TIMESTAMP_START)));
    }
    ...
    public void getScene() throws Exception {
        ...
        restSceneMockMvc.perform(get("/api/scenes/{id}", scene.getId()))
            ...
            .andExpect(jsonPath("$.timestampStart").value(DEFAULT_TIMESTAMP_START));
    }
    @Test
    @Transactional
