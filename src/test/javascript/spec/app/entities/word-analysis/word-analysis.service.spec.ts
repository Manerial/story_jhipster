...
describe('Service Tests', () => {
  describe('WordAnalysis Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(WordAnalysisService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new WordAnalysis(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a WordAnalysis', () => {
        ...
        service.create(new WordAnalysis()).subscribe(resp => (expectedResult = resp.body));
