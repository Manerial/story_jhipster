...
import { BookStatusComponent } from 'app/entities/bookStatus/bookStatus.component';
...
describe('Component Tests', () => {
  describe('BookStatus Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bookStatuses && comp.bookStatuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
