...
public class WordAnalysisResource {
	 ...
	 *         body the new wordAnalysisDTO, or with status
	 *         {@code 400 (Bad Request)} if the wordAnalysis has already an ID.
	 * @throws URISyntaxException if the Location URI syntax is incorrect.
	 */
	@PostMapping("/word-analyses")
	public ResponseEntity<WordAnalysisDTO> createWordAnalysis(@RequestBody WordAnalysisDTO wordAnalysisDTO)
		...
		return ResponseEntity
				.created(new URI("/api/word-analyses/" + result.getId())).headers(HeaderUtil
	 ...
	 *         the updated wordAnalysisDTO, or with status {@code 400 (Bad Request)}
	 *         if the wordAnalysisDTO is not valid, or with status
	 *         {@code 500 (Internal Server Error)} if the wordAnalysisDTO couldn't
	 *         be updated.
	 * @throws URISyntaxException if the Location URI syntax is incorrect.
	 */
	@PutMapping("/word-analyses")
	public ResponseEntity<WordAnalysisDTO> updateWordAnalysis(@RequestBody WordAnalysisDTO wordAnalysisDTO)
			throws URISyntaxException {
		...
		return ResponseEntity.ok().headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME,
				wordAnalysisDTO.getId().toString())).body(result);
	}
	 ...
	 * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
	 *         the wordAnalysisDTO, or with status {@code 404 (Not Found)}.
	 */
