...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
	...
	public ResponseEntity<Problem> process(@Nullable ResponseEntity<Problem> entity, NativeWebRequest request) {
		...
		if (nativeRequest == null) {
			throw new BadRequestAlertException("EXT_ERROR", "EXT", "EXT");
		}
	...
	public ResponseEntity<Problem> handleEmailAlreadyUsedException(
			com.jher.nid_aux_histoires.service.EmailAlreadyUsedException ex, NativeWebRequest request) {
	...
	public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
			com.jher.nid_aux_histoires.service.UsernameAlreadyUsedException ex, NativeWebRequest request) {
	...
	public ResponseEntity<Problem> handleInvalidPasswordException(
			com.jher.nid_aux_histoires.service.InvalidPasswordException ex, NativeWebRequest request) {
