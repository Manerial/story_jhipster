...
/**
 * REST controller for managing {@link com.jher.nid_aux_histoires.domain.Chapter}.
 */
@RestController
@RequestMapping("/api")
public class ChapterResource {
     ...
     */
    @GetMapping("/chapters")
    public ResponseEntity<List<ChapterDTO>> getAllChapters(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
