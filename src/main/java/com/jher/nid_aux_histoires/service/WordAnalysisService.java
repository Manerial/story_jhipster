...
public interface WordAnalysisService {
    ...
    /**
     * Updates a wordAnalysis.
     *
     * @param wordAnalysisDTO the entity to update.
     * @return the persisted entity.
     */
    WordAnalysisDTO update(WordAnalysisDTO wordAnalysisDTO);

    /**
     * Partially updates a wordAnalysis.
     *
     * @param wordAnalysisDTO the entity to update partially.
     * @return the persisted entity.
     */
    Optional<WordAnalysisDTO> partialUpdate(WordAnalysisDTO wordAnalysisDTO);
