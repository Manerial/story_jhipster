...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.jher.nid_aux_histoires.domain.Book.class.getName() + ".bookStatuses");
            ...
            createCache(cm, com.jher.nid_aux_histoires.domain.Chapter.class.getName() + ".bookStatuses");
            ...
            createCache(cm, com.jher.nid_aux_histoires.domain.BookStatus.class.getName());
