...
type ImageFormGroupContent = {
  ...
  picture: FormControl<IImage['picture']>;
  pictureContentType: FormControl<IImage['pictureContentType']>;
  preview: FormControl<IImage['preview']>;
  previewContentType: FormControl<IImage['previewContentType']>;
};
...
export class ImageFormService {
  createImageFormGroup(image: ImageFormGroupInput = { id: null }): ImageFormGroup {
    ...
    return new FormGroup<ImageFormGroupContent>({
      ...
      picture: new FormControl(imageRawValue.picture),
      pictureContentType: new FormControl(imageRawValue.pictureContentType),
      preview: new FormControl(imageRawValue.preview),
      previewContentType: new FormControl(imageRawValue.previewContentType),
    });
  }
