...
export class PartComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.partService
      ...
      .subscribe(
        (res: HttpResponse<IPart[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInParts(): void {
    this.eventSubscriber = this.eventManager.subscribe('partListModification', () => this.loadPage());
  }
