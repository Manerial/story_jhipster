...
export class IdeaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.ideaService
      ...
      .subscribe(
        (res: HttpResponse<IIdea[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInIdeas(): void {
    this.eventSubscriber = this.eventManager.subscribe('ideaListModification', () => this.loadPage());
  }
